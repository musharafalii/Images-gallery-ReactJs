...
const ProductList = () => {
    ...
    return (
        <div className="">
            ...
            <p className=" w-100 py-2 justify-content-center text-center  text-uppercase px-6 fs-5 font-semibold">cart Items</p>
                            ...
                            <>
                                ...
                                <table className="my-2">
                                    <tr className="m-auto  border">
                                        <td className="w-25 m-auto p-auto"><img src={cartItem.avatar} className="m-auto w-100 " alt="error" /> </td>
                                        <td className="w-25 p-4 text-uppercase"><span className="uppercase fs-6 pt-2">{cartItem.name}</span></td>
                ...
                <div className="col-md-4  p-1  mt-3 ">
                    <table>
                        {cart?.map((cartItem, cartindex) => {
                            return (
                                <tr>
                                    <td className="border pb-4 pt-3 pl-2 uppercase text-xs w-50">
                                        {cartItem.name}
                                    </td>
                                    ...
                                    <td className="border w-25 text-center">
                                        ...
                                        <button
                                            className="btn border rounded-0 p-1 text-xs bg-black text-white"
                    ...
                    <div className="p-2 d-flex">
                        ...
                        <div className="col-md-6 ">
                            <Link to="/checkout">
                                <button className="btn border m-4 text-uppercase bg-black text-white uppercase  ml-20 mt-20 rounded-0">
                                    checkout
                                </button>
                            </Link>
                        </div>
